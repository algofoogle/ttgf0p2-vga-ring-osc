...
# ANTON:
# Declare internal_clock as a primary clock at ~350 MHz.
...
create_clock -name internal_clk -period 2.8 [get_pins tt_um_algofoogle_vgaringosc/vgaringosc/workerclkbuff_notouch_/Z]
